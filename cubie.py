...
from marcs.TwoPhaseSolver.defs import cornerFacelet, edgeFacelet, cornerColor, edgeColor, N_SYM
from marcs.TwoPhaseSolver.enums import Color, Corner as Co, Edge as Ed
import marcs.TwoPhaseSolver.face as face
from marcs.TwoPhaseSolver.misc import c_nk, rotate_left, rotate_right
...
class CubieCube:
    ...
    def symmetries(self):
        ...
        from marcs.TwoPhaseSolver.symmetries import symCube, inv_idx  # not nice here but else we have circular imports
        s = []
        d = CubieCube()
